...
public class PastStud {
    ...
    public void studentsTableSchool(JTable table, String valueToSearch) {
        ...
        try {
            ps = con.prepareStatement("SELECT * FROM school_students WHERE CONCAT (phone)LIKE ? and school_students.living_status='Leaved'");
            ...
            Logger.getLogger(PastStud.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void studentsTableUni(JTable table, String valueToSearch) {
        ...
        PreparedStatement ps;
        try {
            ps = con.prepareStatement("SELECT * FROM uni_students WHERE CONCAT (phone)LIKE ? and uni_students.living_status='Leaved'");
            ps.setString(1, "%" + valueToSearch + "%");
